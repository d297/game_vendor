...
var IconicMultiSelect = (function () {
  function IconicMultiSelect(_ref) {
    ...
    this._itemTemplate =
      itemTemplate !== null && itemTemplate !== void 0 ? itemTemplate : null;
    this._noData =
    ...
    this._tagTemplate =
      tagTemplate !== null && tagTemplate !== void 0 ? tagTemplate : null;
    this._textField =
  ...
  _createClass(IconicMultiSelect, [
    {
      ...
      value: function init() {
        if (
          ...
          this._selectContainer.nodeName === "SELECT"
        ) {
    ...
    },
    {
      ...
      value: function _addOptionToList(option, index) {
        ...
        var html = '<span class="multiselect__selected" data-value="'
          .concat(option.value, '">')
          .concat(
            this._tagTemplate
              ? this._processTemplate(this._tagTemplate, index)
              : option.text,
            '<span class="multiselect__remove-btn">'
          )
          .concat(this._cross, "</span></span>");

        this._domElements.input.insertAdjacentHTML("beforebegin", html);

        var _this$_multiselect$qu = this._multiselect.querySelector(
      ...
      value: function _filterOptions(value) {
        ...
        if (this._domElements.options.list.length > 0) {
          for (var i = 0; i < this._domElements.options.list.length; i++) {
            ...
            var text = this._itemTemplate
              ? this._data[i][this._textField]
              : el.textContent;

            if (
              text.toLowerCase().substring(0, valueLowerCase.length) ===
              valueLowerCase
            ) {
          ...
          var hasResults = this._domElements.options.some(function (el, index) {
            return (
              (_this4._itemTemplate
                ? _this4._data[index][_this4._textField]
                : el.textContent
              )
                .toLowerCase()
        ...
        if (this._data.length > 0 && this._valueField && this._textField) {
          ...
          for (var i = 0; i < this._data.length; i++) {
            ...
            arr.push({
              ...
              selected:
                typeof item.selected === "boolean" ? item.selected : false,
            });
          }
      ...
      value: function _handleBackspace(e) {
        if (e.keyCode === 8 && e.target.value === "") {
          ...
          if (lastSelectedOption) {
            var targetLastSelectedOption = this._multiselect.querySelector(
      ...
      value: function _handleOption(target) {
        ...
        for (var _i = 0; _i < this._options.length; _i++) {
          ...
          if (option.value == target.dataset.value) {
            ...
            this._selectedOptions = [].concat(
              _toConsumableArray(this._selectedOptions),
              [option]
            );
      ...
      value: function _initSelectedList() {
        ...
        var _loop2 = function _loop2(i) {
          ...
          if (option.selected) {
            ...
            target.classList.add("multiselect__options--selected");
            _this5._selectedOptions = [].concat(
              _toConsumableArray(_this5._selectedOptions),
              [option]
            );
      ...
      value: function _processTemplate(template, index) {
        ...
        for (var i = 0; i < objAttr.length; i++) {
          ...
          processedTemplate = processedTemplate.replace(
            "${".concat(attr, "}"),
            (_this$_data$index$att = this._data[index][attr]) !== null &&
              _this$_data$index$att !== void 0
              ? _this$_data$index$att
              : ""
          );
        }
    ...
    },
    {
      ...
      value: function _removeOptionFromList(value) {
        var optionDom = this._multiselect.querySelector(
                ...
                ? this._options
                    .map(function (option, index) {
                      return '\n              <li data-value="'
                        .concat(option.value, '">')
                        .concat(
                          _this6._processTemplate(_this6._itemTemplate, index),
                          "</li>\n            "
                        );
                    })
                    .join("")
    ...
    },
    {
      ...
      value: function _renderMultiselect() {
        ...
        var html = '\n      <div id="'
          .concat(
            id,
            '" class="multiselect__container">\n        <div class="multiselect__wrapper">\n          <button class="multiselect__input" placeholder="'
          )
          .concat(
            this._placeholder,
            '" />\n        </div>\n        <span style="display: none;" class="multiselect__clear-btn">'
          )
          .concat(this._cross, "</span>\n      </div>\n    ");
    ...
    },
    {
      ...
      value: function _showNoData(condition) {
        return condition
          ? '<p class="multiselect__options--no-data">'.concat(
              this._noData,
              "</p>"
            )
          : "";
    ...
    },
    {
      ...
      value: function _showNoResults(condition) {
        var dom = this._multiselect.querySelector(
          ".multiselect__options--no-results"
        );

        if (condition) {
          var html = '<p class="multiselect__options--no-results">'.concat(
            this._noResults,
            "</p>"
          );
          !dom &&
...
multiSelect.subscribe(function (event) {
  ...
  if (event.selection.length >= 2) {
    const wrapper = document.querySelector(".multiselect__wrapper");
    const elements = wrapper.querySelectorAll(".multiselect__selected");
